...
public class BusinessUsuarios implements IBusinessUsuarios {
	...
	public void deletarUsuario(Usuario usuario) {
		try {
			dao.deletar(usuario);
			Fachada.getInstance().getDaoVendas().deletarPedidoCliente(usuario.getLogin());
			Fachada.getInstance().getDaoEncomendas().deletarEncomendaFornecedor(usuario.getLogin());
