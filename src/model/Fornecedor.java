...
public class Fornecedor extends Usuario {
	...
	public Fornecedor(String login, String senha, String email) {
		super(login, senha, email, "Fornecedor");
	}
	
	public void atualizarDataEncomendas() throws SQLException{
		encomendas = App.fachada.getDaoEncomendas().dataEncomendasFornecedor(this);
	}
